...
param([string]$monthName = "February", [string]$monthPattern = "2026-02-*", [string]$newPattern = "2026-02-08*")
...
try {
	...
	WriteREADME "**Today** (Monday), the latest releases of **featured** GitHub repos are: $ln`n"
