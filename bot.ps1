...
try {
	...
	WriteLine "**NOTE:** 🆕 *= new project,* ☀️ *= new release in $month,* 🔖 *= new tag in $month*, 💤 *= no activity for 90+ days*, *auto-generated from $($global:numRepos) repos on $today by our friendly bot 🤖 (see [bot.ps1](bot.ps1))*.`n"
