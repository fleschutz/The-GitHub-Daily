...
param([string]$monthName = "February", [string]$monthPattern = "2026-02-*", [string]$newPattern = "2026-02-03*")
...
try {
	...
	WriteREADME "As of **Wednesday** the latest releases of **featured** GitHub repos are: $ln`n"
