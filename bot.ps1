...
param([string]$monthName = "February", [string]$monthPattern = "2026-02-*", [string]$newPattern = "2026-02-13*")
...
try {
	...
	WriteLine "**Today** (Saturday), the latest releases of **featured** GitHub repos are: $ln"
	WriteLine ""
