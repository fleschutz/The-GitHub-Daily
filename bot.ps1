...
try {
	...
	WriteLine "========================="
	WriteLine ""
	WriteLine "**GitHub, Today Sept. 30 - The latest releases of selected GitHub repositories are listed below:** *(generated by bot.ps1)*"
	WriteLine ""
	...
	WriteLine "The latest releases or tags in the **Featured** section are: $ln`n"
