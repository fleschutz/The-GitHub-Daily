...
param([string]$monthName = "February", [string]$monthPattern = "2026-02-*", [string]$newPattern = "2026-02-12*")
...
try {
	...
	WriteLine "**Today** (Friday), the latest releases of **featured** GitHub repos are: $ln"
	WriteLine ""
