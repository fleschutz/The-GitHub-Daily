...
param([string]$monthName = "February", [string]$monthPattern = "2026-02-*", [string]$newPattern = "2026-02-05*")
...
try {
	...
	WriteREADME "As of **Friday** the latest releases of **featured** GitHub repos are: $ln`n"
