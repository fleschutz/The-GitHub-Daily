...
param([string]$monthPattern = "2026-07-*", [string]$newPattern = "2026-07-21*")
...
try {
	...
	WriteLine "**Update:** of $today from $($global:numRepos) selected GitHub repositories by our friendly 🤖 [bot script](bot.ps1).*`n"
