...
param([string]$monthName = "February", [string]$monthPattern = "2026-02-*", [string]$newPattern = "2026-02-15*")
...
try {
	...
	WriteLine "**Today** (Monday), the latest releases of **featured** GitHub repos are: $ln"
	WriteLine ""
